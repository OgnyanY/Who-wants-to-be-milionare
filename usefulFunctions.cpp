...
//        i--) {  // coppying all elemtnts 'i' positions forward, so new
//        characters
...
//   int questionSize = StrLength(question);  // finding the size of the
//   question
...
//   // side 2 steps over, then rewrites the found position to a new line, and
//   the
