...
void FiftyFiftyJoker::eraseWrongAnswer(int indexToDelete, Question &question) {
    switch (indexToDelete) {
        case 1:
            fillingWithEmptySpace(question.firstAnswer, question.firstAnswer.size());
            break;
        case 2:
            fillingWithEmptySpace(question.secondAnswer, question.secondAnswer.size());
            break;
        case 3:
            fillingWithEmptySpace(question.thirdAnswer, question.thirdAnswer.size());
            break;
        case 4:
            fillingWithEmptySpace(question.forthAnswer, question.forthAnswer.size());
            break;
        default:
            break;
    }
